...
@Data
public class PageResponsePointDTO {
    ...
    @Builder
    public PageResponsePointDTO(PageRequestPointDTO pageRequestPointDTO, int total){
        ...
        this.currentPage = pager.getCurrentPage(pageRequestPointDTO.getPg());
        this.total = total;
        ...
        this.dateType = pageRequestPointDTO.getDateType();
